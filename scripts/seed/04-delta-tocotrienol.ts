/**
 * Seed Core Compounds: Delta-Tocotrienol
 *
 * Run: npx tsx scripts/seed/04-delta-tocotrienol.ts
 */
...
const compound = { name: 'Delta-Tocotrienol', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '347', sourceName: 'Tocotrienol, delta', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '347', sourceName: 'Tocotrienol, delta', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'TOCTRD', sourceName: 'Delta tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'TOCTRG', sourceName: 'δ-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB001299', sourceName: 'd-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Delta-Tocotrienol...\n');
