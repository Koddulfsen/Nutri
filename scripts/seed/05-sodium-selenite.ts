/**
 * Seed Core Compounds: Sodium Selenite
 *
 * Run: npx tsx scripts/seed/05-sodium-selenite.ts
 */
...
const compound = { name: 'Sodium Selenite', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB027901', sourceName: 'Selenite', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Sodium Selenite...\n');
