/**
 * Seed Core Compounds: Adenosylcobalamin
 *
 * Run: npx tsx scripts/seed/04-adenosylcobalamin.ts
 */
...
const compound = { name: 'Adenosylcobalamin', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022837', sourceName: 'Adenosylcobalamin', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Adenosylcobalamin...\n');
