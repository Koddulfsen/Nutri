/**
 * Seed Core Compounds: Vitamin K2 MK-9
 *
 * Run: npx tsx scripts/seed/04-vitamin-k2-mk9.ts
 */
...
const compound = { name: 'Vitamin K2 MK-9', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FRIDA', externalId: '438', sourceName: 'Menaquinone 9', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Vitamin K2 MK-9...\n');
