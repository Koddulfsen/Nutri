/**
 * Seed Core Compounds: Thiamin HCl
 *
 * Run: npx tsx scripts/seed/04-thiamin-hcl.ts
 */
...
const compound = { name: 'Thiamin HCl', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB008416', sourceName: 'Thiamine hydrochloride', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Thiamin HCl...\n');
