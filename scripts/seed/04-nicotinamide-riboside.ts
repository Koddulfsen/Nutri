/**
 * Seed Core Compounds: Nicotinamide Riboside (NR)
 *
 * Run: npx tsx scripts/seed/04-nicotinamide-riboside.ts
 */
...
const compound = { name: 'Nicotinamide Riboside (NR)', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022281', sourceName: 'Nicotinamide riboside', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Nicotinamide Riboside (NR)...\n');
