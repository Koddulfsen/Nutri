/**
 * Seed Core Compounds: Vitamin K (Total)
 *
 * Run: npx tsx scripts/seed/04-vitamin-k.ts
 */
...
const compound = { name: 'Vitamin K (Total)', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '1185', sourceName: 'Vitamin K (phylloquinone)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '430', sourceName: 'Vitamin K (phylloquinone)', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'VITK', sourceName: 'Vitamin K', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'Fineli', externalId: 'VITK', sourceName: 'Vitamin K', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'VITK', sourceName: 'Vitamin K', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'NEVO', externalId: 'VITK', sourceName: 'Vitamin K total', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '442', sourceName: 'Vitamin K', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'MEXT', externalId: 'col:48', sourceName: 'ビタミンK', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Vitamin K (Total)...\n');
