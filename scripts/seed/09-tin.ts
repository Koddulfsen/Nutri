/**
 * Seed Core Compounds: Tin (Sn)
 *
 * Run: npx tsx scripts/seed/09-tin.ts
 */
...
const compound = { name: 'Tin (Sn)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'SN', sourceName: 'Tin (Sn)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'SN', sourceName: 'Tin', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '260', sourceName: 'Tin', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003722', sourceName: 'Tin', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Tin (Sn)...\n');
