/**
 * Seed Core Compounds: Free Choline
 *
 * Run: npx tsx scripts/seed/04-free-choline.ts
 */
...
const compound = { name: 'Free Choline', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '1181', sourceName: 'Choline, free', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '421', sourceName: 'Choline, free', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Free Choline...\n');
