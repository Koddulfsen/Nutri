/**
 * Seed Core Compounds: Acesulfame-K
 *
 * Run: npx tsx scripts/seed/08-acesulfame-k.ts
 */
...
const compound = { name: 'Acesulfame-K', unit: 'mg', type: 'SYNTHETIC_ADDITIVE' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB012173', sourceName: 'Acesulfame K', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Acesulfame-K...\n');
