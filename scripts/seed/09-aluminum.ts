/**
 * Seed Core Compounds: Aluminum (Al)
 *
 * Run: npx tsx scripts/seed/09-aluminum.ts
 */
...
const compound = { name: 'Aluminum (Al)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'AL', sourceName: 'Aluminium (Al)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'AL', sourceName: 'Aluminium', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '20', sourceName: 'Aluminum / Aluminium', sourceUnit: 'mg', conversionFactor: '1000' },
  { source: 'FooDB', externalId: 'FDB003570', sourceName: 'Aluminum', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Aluminum (Al)...\n');
