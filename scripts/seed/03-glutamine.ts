/**
 * Seed Core Compounds: Glutamine
 * Note: Most databases combine Glutamine with Glutamic acid; only FooDB has separate entry
 *
 * Run: npx tsx scripts/seed/03-glutamine.ts
 */
...
const compound = { name: 'Glutamine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FooDB', externalId: '31128', sourceName: 'L-glutamine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Glutamine...\n');
