/**
 * Seed Core Compounds: Isoleucine
 *
 * Parsed from: docs/compound-mappings/03-macronutrients.md
 *
 * Run: npx tsx scripts/seed/03-isoleucine.ts
 */
...
// =============================================================================
// Isoleucine - 1 compound, 6 mappings (verified against local data 2025-02-04)
...
const mappings = [
  // FDC (1)
  { source: 'FDC', externalId: '1212', sourceName: 'Isoleucine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  // CNF (1)
  { source: 'CNF', externalId: '503', sourceName: 'ISOLEUCINE', sourceUnit: 'g', conversionFactor: '1.0' },
  // AFCD (1) - unit is mg/g N (per gram nitrogen), complex conversion
  { source: 'AFCD', externalId: 'Isoleucine', sourceName: 'Isoleucine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  // FOODfiles (1)
  { source: 'FOODfiles', externalId: 'ILE', sourceName: 'Isoleucine', sourceUnit: 'mg', conversionFactor: '0.001' },
  // BLS (1)
  { source: 'BLS', externalId: 'ILE', sourceName: 'Isoleucin', sourceUnit: 'g', conversionFactor: '1.0' },
  // FRIDA (1)
  { source: 'FRIDA', externalId: '161', sourceName: 'Isoleucin', sourceUnit: 'mg', conversionFactor: '0.001' },
];
...
async function seed() {
  console.log('Seeding Isoleucine...\n');
