/**
 * Seed Core Compounds: Vitamin K2 MK-4
 *
 * Run: npx tsx scripts/seed/04-vitamin-k2-mk4.ts
 */
...
const compound = { name: 'Vitamin K2 MK-4', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '428', sourceName: 'Menaquinone-4', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '428', sourceName: 'Menaquinone-4', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '433', sourceName: 'Menaquinone 4', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB029792', sourceName: 'Menatetrenone', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Vitamin K2 MK-4...\n');
