/**
 * Seed Core Compounds: CLA (Conjugated Linoleic Acid)
 *
 * Run: npx tsx scripts/seed/03-cla.ts
 */
...
const compound = { name: 'CLA', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FDC', externalId: '670', sourceName: '18:2 CLAs', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '670', sourceName: '18:2 CLAs', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'F18D2CN9TN11', sourceName: 'Fatty acid cis, trans 18:2 omega-9, 11', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'F18:2C9T11', sourceName: 'Fatty acid C18:2 conjugated, cis 9,trans 11', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'NEVO', externalId: 'F18:2CT', sourceName: 'C18:2 cis trans', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '72', sourceName: 'C18:2,conjugated', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: '121369', sourceName: 'Rumenic acid', sourceUnit: 'g', conversionFactor: '1.0' },
];
