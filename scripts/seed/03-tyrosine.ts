/**
 * Seed Core Compounds: Tyrosine
 *
 * Run: npx tsx scripts/seed/03-tyrosine.ts
 */
...
const compound = { name: 'Tyrosine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1218', sourceName: 'Tyrosine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '509', sourceName: 'TYROSINE', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Tyrosine', sourceName: 'Tyrosine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'TYR', sourceName: 'Tyrosine', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'TYR', sourceName: 'Tyrosin', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '264', sourceName: 'Tyrosin', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'FooDB', externalId: '446', sourceName: 'L-Tyrosine', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Tyrosine...\n');
