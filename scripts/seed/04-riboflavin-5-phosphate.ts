/**
 * Seed Core Compounds: Riboflavin-5-Phosphate (R5P)
 *
 * Run: npx tsx scripts/seed/04-riboflavin-5-phosphate.ts
 */
...
const compound = { name: 'Riboflavin-5-Phosphate (R5P)', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB030862', sourceName: 'FMN (Flavin mononucleotide)', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Riboflavin-5-Phosphate (R5P)...\n');
