/**
 * Seed Core Compounds: Xylitol
 *
 * Run: npx tsx scripts/seed/03-xylitol.ts
 */
...
const compound = { name: 'Xylitol', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'AFCD', externalId: 'XYLTL', sourceName: 'Xylitol', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'BLS', externalId: 'XYLTL', sourceName: 'Xylitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: '1134', sourceName: 'Xylitol', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Xylitol...\n');
