/**
 * Seed Core Compounds: Mannitol
 *
 * Run: npx tsx scripts/seed/03-mannitol.ts
 */
...
const compound = { name: 'Mannitol', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FDC', externalId: '260', sourceName: 'Mannitol', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '260', sourceName: 'Mannitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'MANTL', sourceName: 'Mannitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'MANTL', sourceName: 'Mannitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: '1982', sourceName: 'D-Mannitol', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Mannitol...\n');
