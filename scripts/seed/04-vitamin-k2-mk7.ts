/**
 * Seed Core Compounds: Vitamin K2 MK-7
 *
 * Run: npx tsx scripts/seed/04-vitamin-k2-mk7.ts
 */
...
const compound = { name: 'Vitamin K2 MK-7', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FRIDA', externalId: '436', sourceName: 'Menaquinone 7', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Vitamin K2 MK-7...\n');
