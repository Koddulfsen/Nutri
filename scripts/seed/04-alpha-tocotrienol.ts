/**
 * Seed Core Compounds: Alpha-Tocotrienol
 *
 * Run: npx tsx scripts/seed/04-alpha-tocotrienol.ts
 */
...
const compound = { name: 'Alpha-Tocotrienol', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '344', sourceName: 'Tocotrienol, alpha', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '344', sourceName: 'Tocotrienol, alpha', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'TOCTRA', sourceName: 'Alpha tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'TOCTRA', sourceName: 'Alpha-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '277', sourceName: 'alpha-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'TOCTRA', sourceName: 'α-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB002434', sourceName: '(R)-alpha-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Alpha-Tocotrienol...\n');
