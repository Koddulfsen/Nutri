/**
 * Seed Core Compounds: Retinal
 *
 * Run: npx tsx scripts/seed/04-retinal.ts
 */
...
const compound = { name: 'Retinal', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022576', sourceName: 'Retinal', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Retinal...\n');
