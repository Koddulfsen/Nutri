/**
 * Seed Core Compounds: Soluble Fiber
 *
 * Run: npx tsx scripts/seed/03-soluble-fiber.ts
 */
...
const compound = { name: 'Soluble Fiber', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FDC', externalId: '1082', sourceName: 'Fiber, soluble', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '295', sourceName: 'Fibre, soluble', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'FIBSOL', sourceName: 'Fibre, water-soluble', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'FIBSOL', sourceName: 'Fibre, water-soluble', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'FIBSOL', sourceName: 'Water Soluble Dietary Fiber', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Soluble Fiber...\n');
