/**
 * Seed Core Compounds: Dexpanthenol
 *
 * Run: npx tsx scripts/seed/04-dexpanthenol.ts
 */
...
const compound = { name: 'Dexpanthenol', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB008430', sourceName: 'Dexpanthenol', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Dexpanthenol...\n');
