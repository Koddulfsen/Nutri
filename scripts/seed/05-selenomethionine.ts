/**
 * Seed Core Compounds: Selenomethionine
 *
 * Run: npx tsx scripts/seed/05-selenomethionine.ts
 */
...
const compound = { name: 'Selenomethionine', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB012156', sourceName: 'L-Selenomethionine', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Selenomethionine...\n');
