/**
 * Seed Core Compounds: Theophylline
 *
 * Run: npx tsx scripts/seed/06-theophylline.ts
 */
...
const compound = { name: 'Theophylline', unit: 'mg', type: 'ALKALOID' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB000453', sourceName: 'Theophylline', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Theophylline...\n');
