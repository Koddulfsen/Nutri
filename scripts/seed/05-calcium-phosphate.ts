/**
 * Seed Core Compounds: Calcium Phosphate
 *
 * Run: npx tsx scripts/seed/05-calcium-phosphate.ts
 */
...
const compound = { name: 'Calcium Phosphate', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB013356', sourceName: 'Calcium phosphate', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Calcium Phosphate...\n');
