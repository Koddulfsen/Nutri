/**
 * Seed Core Compounds: Ascorbic Acid
 *
 * Run: npx tsx scripts/seed/04-ascorbic-acid.ts
 */
...
const compound = { name: 'Ascorbic Acid', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FRIDA', externalId: '175', sourceName: 'Ascorbic acid', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: 'FDB001223', sourceName: 'Ascorbic acid', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Ascorbic Acid...\n');
