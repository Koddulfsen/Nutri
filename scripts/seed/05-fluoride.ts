/**
 * Seed Core Compounds: Fluoride
 *
 * Run: npx tsx scripts/seed/05-fluoride.ts
 */
...
const compound = { name: 'Fluoride', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FDC', externalId: '1099', sourceName: 'Fluoride, F', sourceUnit: 'µg', conversionFactor: '0.001', isCanonical: true },
  { source: 'CNF', externalId: '313', sourceName: 'Fluoride, F', sourceUnit: 'µg', conversionFactor: '0.001' },
  { source: 'AFCD', externalId: 'Fluoride (F)', sourceName: 'Fluoride (F)', sourceUnit: 'µg', conversionFactor: '0.001' },
  { source: 'FOODfiles', externalId: 'FD', sourceName: 'Fluoride', sourceUnit: 'µg', conversionFactor: '0.001' },
  { source: 'Fineli', externalId: 'FD', sourceName: 'Fluoride', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'FD', sourceName: 'Fluorid', sourceUnit: 'µg', conversionFactor: '0.001' },
  { source: 'FRIDA', externalId: '142', sourceName: 'Fluor', sourceUnit: 'µg', conversionFactor: '0.001' },
  { source: 'FooDB', externalId: 'FDB004485', sourceName: 'Fluoride', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Fluoride...\n');
