/**
 * Seed Core Compounds: Calcium Carbonate
 *
 * Run: npx tsx scripts/seed/05-calcium-carbonate.ts
 */
...
const compound = { name: 'Calcium Carbonate', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB015437', sourceName: 'Calcium carbonate', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Calcium Carbonate...\n');
