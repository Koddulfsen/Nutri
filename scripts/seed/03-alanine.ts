/**
 * Seed Core Compounds: Alanine
 *
 * Run: npx tsx scripts/seed/03-alanine.ts
 */
...
const compound = { name: 'Alanine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1222', sourceName: 'Alanine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '513', sourceName: 'ALANINE', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Alanine', sourceName: 'Alanine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'ALA', sourceName: 'Alanine', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'ALA', sourceName: 'Alanin', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '17', sourceName: 'Alanin', sourceUnit: 'mg', conversionFactor: '0.001' },
];

async function seed() {
  console.log('Seeding Alanine...\n');
