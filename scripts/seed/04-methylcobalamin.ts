/**
 * Seed Core Compounds: Methylcobalamin
 *
 * Run: npx tsx scripts/seed/04-methylcobalamin.ts
 */
...
const compound = { name: 'Methylcobalamin', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022939', sourceName: 'Methylcobalamin', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Methylcobalamin...\n');
