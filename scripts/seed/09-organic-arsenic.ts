/**
 * Seed Core Compounds: Organic Arsenic
 *
 * Run: npx tsx scripts/seed/09-organic-arsenic.ts
 */
...
const compound = { name: 'Organic Arsenic', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB011219', sourceName: 'Arsenobetaine', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Organic Arsenic...\n');
