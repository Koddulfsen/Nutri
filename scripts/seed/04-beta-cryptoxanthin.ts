/**
 * Seed Core Compounds: Beta-Cryptoxanthin
 *
 * Run: npx tsx scripts/seed/04-beta-cryptoxanthin.ts
 */
...
const compound = { name: 'Beta-Cryptoxanthin', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '1120', sourceName: 'Cryptoxanthin, beta', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '334', sourceName: 'Cryptoxanthin, beta', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'CRYPX', sourceName: 'Cryptoxanthin', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'NEVO', externalId: 'CRYPXB', sourceName: 'Beta-cryptoxanthin', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'CRYPX', sourceName: 'β-Cryptoxanthin', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB012019', sourceName: 'beta-Cryptoxanthin', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Beta-Cryptoxanthin...\n');
