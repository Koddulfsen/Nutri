/**
 * Seed Core Compounds: Arginine
 *
 * Run: npx tsx scripts/seed/03-arginine.ts
 */
...
const compound = { name: 'Arginine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1220', sourceName: 'Arginine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '511', sourceName: 'ARGININE', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Arginine', sourceName: 'Arginine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'ARG', sourceName: 'Arginine', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'ARG', sourceName: 'Arginin', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '31', sourceName: 'Arginin', sourceUnit: 'mg', conversionFactor: '0.001' },
];

async function seed() {
  console.log('Seeding Arginine...\n');
