/**
 * Seed Core Compounds: Non-Heme Iron
 *
 * Run: npx tsx scripts/seed/05-non-heme-iron.ts
 */
...
const compound = { name: 'Non-Heme Iron', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'NEVO', externalId: 'NHAEM', sourceName: 'IJzer non haem', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Non-Heme Iron...\n');
