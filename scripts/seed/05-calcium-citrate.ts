/**
 * Seed Core Compounds: Calcium Citrate
 *
 * Run: npx tsx scripts/seed/05-calcium-citrate.ts
 */
...
const compound = { name: 'Calcium Citrate', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB013368', sourceName: 'Calcium citrate', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Calcium Citrate...\n');
