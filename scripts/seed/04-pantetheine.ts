/**
 * Seed Core Compounds: Pantetheine
 *
 * Run: npx tsx scripts/seed/04-pantetheine.ts
 */
...
const compound = { name: 'Pantetheine', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB023172', sourceName: 'Pantetheine', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Pantetheine...\n');
