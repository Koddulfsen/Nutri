/**
 * Seed Core Compounds: Alpha-Carotene
 *
 * Run: npx tsx scripts/seed/04-alpha-carotene.ts
 */
...
const compound = { name: 'Alpha-Carotene', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '1108', sourceName: 'Carotene, alpha', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '322', sourceName: 'Carotene, alpha', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'CARTA', sourceName: 'Alpha-carotene', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'CARTA', sourceName: 'Alpha-carotene', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'NEVO', externalId: 'CARTA', sourceName: 'Alfa-carotene', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'CARTA', sourceName: 'α-Carotene', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB013716', sourceName: 'alpha-Carotene', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Alpha-Carotene...\n');
