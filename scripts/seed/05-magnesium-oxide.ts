/**
 * Seed Core Compounds: Magnesium Oxide
 *
 * Run: npx tsx scripts/seed/05-magnesium-oxide.ts
 */
...
const compound = { name: 'Magnesium Oxide', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB015358', sourceName: 'Magnesium oxide', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Magnesium Oxide...\n');
