/**
 * Seed Core Compounds: Folinic Acid
 *
 * Run: npx tsx scripts/seed/04-folinic-acid.ts
 */
...
const compound = { name: 'Folinic Acid', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022689', sourceName: '5-Formyltetrahydrofolic acid', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Folinic Acid...\n');
