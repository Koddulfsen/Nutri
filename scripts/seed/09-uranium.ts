/**
 * Seed Core Compounds: Uranium (U)
 *
 * Run: npx tsx scripts/seed/09-uranium.ts
 */
...
const compound = { name: 'Uranium (U)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB003727', sourceName: 'Uranium', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Uranium (U)...\n');
