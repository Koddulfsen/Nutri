/**
 * Seed Core Compounds: Lactitol
 *
 * Run: npx tsx scripts/seed/03-lactitol.ts
 */
...
const compound = { name: 'Lactitol', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FooDB', externalId: '20787', sourceName: 'Lactitol', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Lactitol...\n');
