/**
 * Seed Core Compounds: Resistant Starch
 *
 * Run: npx tsx scripts/seed/03-resistant-starch.ts
 */
...
const compound = { name: 'Resistant Starch', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'AFCD', externalId: 'Resistant starch', sourceName: 'Resistant starch', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'STARES', sourceName: 'Starch, resistant', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Resistant Starch...\n');
