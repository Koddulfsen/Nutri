/**
 * Seed Core Compounds: Lead (Pb)
 *
 * Run: npx tsx scripts/seed/09-lead.ts
 */
...
const compound = { name: 'Lead (Pb)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'PB', sourceName: 'Lead (Pb)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'PB', sourceName: 'Lead', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '43', sourceName: 'Lead / Bly', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003777', sourceName: 'Lead', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Lead (Pb)...\n');
