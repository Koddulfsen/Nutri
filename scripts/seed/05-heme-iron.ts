/**
 * Seed Core Compounds: Heme Iron
 *
 * Run: npx tsx scripts/seed/05-heme-iron.ts
 */
...
const compound = { name: 'Heme Iron', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'NEVO', externalId: 'HAEM', sourceName: 'IJzer haem', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Heme Iron...\n');
