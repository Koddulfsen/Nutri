/**
 * Seed Core Compounds: Erythritol
 *
 * Run: npx tsx scripts/seed/03-erythritol.ts
 */
...
const compound = { name: 'Erythritol', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'AFCD', externalId: 'ERYTHL', sourceName: 'Erythritol', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: '371', sourceName: 'Erythritol', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Erythritol...\n');
