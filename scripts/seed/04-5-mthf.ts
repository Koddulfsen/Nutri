/**
 * Seed Core Compounds: 5-MTHF (Methylfolate)
 *
 * Run: npx tsx scripts/seed/04-5-mthf.ts
 */
...
const compound = { name: '5-MTHF (Methylfolate)', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022600', sourceName: '5-Methyltetrahydrofolic acid', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding 5-MTHF (Methylfolate)...\n');
