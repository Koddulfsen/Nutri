/**
 * Seed Core Compounds: Aspartame
 *
 * Run: npx tsx scripts/seed/08-aspartame.ts
 */
...
const compound = { name: 'Aspartame', unit: 'mg', type: 'SYNTHETIC_ADDITIVE' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB000569', sourceName: 'Aspartame', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Aspartame...\n');
