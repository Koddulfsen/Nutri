/**
 * Seed Core Compounds: Valine
 *
 * Parsed from: docs/compound-mappings/03-macronutrients.md
 *
 * Run: npx tsx scripts/seed/03-valine.ts
 */
...
const mappings = [
  // FDC
  { source: 'FDC', externalId: '1219', sourceName: 'Valine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  // CNF
  { source: 'CNF', externalId: '510', sourceName: 'VALINE', sourceUnit: 'g', conversionFactor: '1.0' },
  // AFCD
  { source: 'AFCD', externalId: 'Valine', sourceName: 'Valine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  // FOODfiles
  { source: 'FOODfiles', externalId: 'VAL', sourceName: 'Valine', sourceUnit: 'mg', conversionFactor: '0.001' },
  // BLS
  { source: 'BLS', externalId: 'VAL', sourceName: 'Valin', sourceUnit: 'g', conversionFactor: '1.0' },
  // FRIDA
  { source: 'FRIDA', externalId: '266', sourceName: 'Valin', sourceUnit: 'mg', conversionFactor: '0.001' },
];
