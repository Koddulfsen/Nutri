/**
 * Seed Core Compounds: Beta-Glucan
 *
 * Run: npx tsx scripts/seed/03-beta-glucan.ts
 */
...
const compound = { name: 'Beta-Glucan', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FDC', externalId: '2058', sourceName: 'Beta-glucan', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: '5763', sourceName: 'beta-Glucan', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Beta-Glucan...\n');
