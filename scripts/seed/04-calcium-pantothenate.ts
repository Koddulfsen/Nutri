/**
 * Seed Core Compounds: Calcium Pantothenate
 *
 * Run: npx tsx scripts/seed/04-calcium-pantothenate.ts
 */
...
const compound = { name: 'Calcium Pantothenate', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB012193', sourceName: 'Calcium pantothenate', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Calcium Pantothenate...\n');
