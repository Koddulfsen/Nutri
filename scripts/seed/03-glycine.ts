/**
 * Seed Core Compounds: Glycine
 *
 * Run: npx tsx scripts/seed/03-glycine.ts
 */
...
const compound = { name: 'Glycine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1225', sourceName: 'Glycine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '516', sourceName: 'GLYCINE', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Glycine', sourceName: 'Glycine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'GLY', sourceName: 'Glycine', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'GLY', sourceName: 'Glycin', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '153', sourceName: 'Glycin', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'FooDB', externalId: '484', sourceName: 'Glycine', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Glycine...\n');
