/**
 * Seed Core Compounds: Asparagine
 * Note: Only 2 sources have separate Asparagine (most combine with Aspartic acid)
 *
 * Run: npx tsx scripts/seed/03-asparagine.ts
 */
...
const compound = { name: 'Asparagine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FOODfiles', externalId: 'ASN', sourceName: 'Asparagine', sourceUnit: 'mg', conversionFactor: '0.001', isCanonical: true },
  { source: 'FooDB', externalId: '787', sourceName: 'L-Asparagine', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Asparagine...\n');
