/**
 * Seed Core Compounds: Inulin
 *
 * Run: npx tsx scripts/seed/03-inulin.ts
 */
...
const compound = { name: 'Inulin', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'AFCD', externalId: 'INULIN', sourceName: 'Inulin', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: '1141', sourceName: 'Inulin', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Inulin...\n');
