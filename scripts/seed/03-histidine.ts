/**
 * Seed Core Compounds: Histidine
 *
 * Parsed from: docs/compound-mappings/03-macronutrients.md
 *
 * Run: npx tsx scripts/seed/03-histidine.ts
 */
...
// =============================================================================
// Histidine - 1 compound, 6 mappings (verified against local data 2025-02-04)
...
const mappings = [
  // FDC (1)
  { source: 'FDC', externalId: '1221', sourceName: 'Histidine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  // CNF (1)
  { source: 'CNF', externalId: '512', sourceName: 'HISTIDINE', sourceUnit: 'g', conversionFactor: '1.0' },
  // AFCD (1) - unit is mg/g N (per gram nitrogen), complex conversion
  { source: 'AFCD', externalId: 'Histidine', sourceName: 'Histidine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  // FOODfiles (1)
  { source: 'FOODfiles', externalId: 'HIS', sourceName: 'Histidine', sourceUnit: 'mg', conversionFactor: '0.001' },
  // BLS (1)
  { source: 'BLS', externalId: 'HIS', sourceName: 'Histidin', sourceUnit: 'g', conversionFactor: '1.0' },
  // FRIDA (1)
  { source: 'FRIDA', externalId: '159', sourceName: 'Histidin', sourceUnit: 'mg', conversionFactor: '0.001' },
];
