/**
 * Seed Core Compounds: Cobalt (Co)
 *
 * Run: npx tsx scripts/seed/09-cobalt.ts
 */
...
const compound = { name: 'Cobalt (Co)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'CO', sourceName: 'Cobalt (Co)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'CO', sourceName: 'Cobalt', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '120', sourceName: 'Cobalt / Cobolt', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003581', sourceName: 'Cobalt', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Cobalt (Co)...\n');
