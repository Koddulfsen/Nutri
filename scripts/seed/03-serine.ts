/**
 * Seed Core Compounds: Serine
 *
 * Run: npx tsx scripts/seed/03-serine.ts
 */
...
const compound = { name: 'Serine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1227', sourceName: 'Serine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '518', sourceName: 'SERINE', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Serine', sourceName: 'Serine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'SER', sourceName: 'Serine', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'SER', sourceName: 'Serin', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '231', sourceName: 'Serin', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'FooDB', externalId: '12742', sourceName: 'L-Serine', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Serine...\n');
