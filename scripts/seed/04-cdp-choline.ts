/**
 * Seed Core Compounds: CDP-Choline (Citicoline)
 *
 * Run: npx tsx scripts/seed/04-cdp-choline.ts
 */
...
const compound = { name: 'CDP-Choline (Citicoline)', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022608', sourceName: 'Citicoline', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding CDP-Choline (Citicoline)...\n');
