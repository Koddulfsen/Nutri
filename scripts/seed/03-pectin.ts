/**
 * Seed Core Compounds: Pectin
 *
 * Run: npx tsx scripts/seed/03-pectin.ts
 */
...
const compound = { name: 'Pectin', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FooDB', externalId: '23325', sourceName: 'Pectin', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Pectin...\n');
