/**
 * Seed Core Compounds: Nicotinamide
 *
 * Run: npx tsx scripts/seed/04-nicotinamide.ts
 */
...
const compound = { name: 'Nicotinamide', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB012485', sourceName: 'Nicotinamide', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Nicotinamide...\n');
