/**
 * Seed Core Compounds: Pyridoxamine
 *
 * Run: npx tsx scripts/seed/04-pyridoxamine.ts
 */
...
const compound = { name: 'Pyridoxamine', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB021819', sourceName: 'Pyridoxamine', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Pyridoxamine...\n');
