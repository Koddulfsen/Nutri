/**
 * Seed Core Compounds: Sulfur
 *
 * Run: npx tsx scripts/seed/05-sulfur.ts
 */
...
const compound = { name: 'Sulfur', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'Sulphur (S)', sourceName: 'Sulphur (S)', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'S', sourceName: 'Sulphur', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'S', sourceName: 'Schwefel', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '253', sourceName: 'Svovl', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003717', sourceName: 'Sulfur', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Sulfur...\n');
