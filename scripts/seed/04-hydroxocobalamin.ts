/**
 * Seed Core Compounds: Hydroxocobalamin
 *
 * Run: npx tsx scripts/seed/04-hydroxocobalamin.ts
 */
...
const compound = { name: 'Hydroxocobalamin', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB003166', sourceName: 'Hydroxocobalamin', sourceUnit: 'µg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Hydroxocobalamin...\n');
