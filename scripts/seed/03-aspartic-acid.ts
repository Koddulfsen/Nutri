/**
 * Seed Core Compounds: Aspartic Acid
 *
 * Run: npx tsx scripts/seed/03-aspartic-acid.ts
 */
...
const compound = { name: 'Aspartic Acid', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1223', sourceName: 'Aspartic acid', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '514', sourceName: 'ASPARTIC ACID', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Aspartic acid', sourceName: 'Aspartic acid', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'ASP', sourceName: 'Aspartic acid', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'ASP', sourceName: 'Asparaginsäure, inklusive Asparagin', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '34', sourceName: 'Asparaginsyre', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'FooDB', externalId: '12570', sourceName: 'L-Aspartic acid', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Aspartic Acid...\n');
