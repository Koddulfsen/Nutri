/**
 * Seed Core Compounds: Maltitol
 *
 * Run: npx tsx scripts/seed/03-maltitol.ts
 */
...
const compound = { name: 'Maltitol', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'AFCD', externalId: 'MALTL', sourceName: 'Maltitol', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: '20377', sourceName: 'Maltitoll', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Maltitol...\n');
