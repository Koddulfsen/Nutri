/**
 * Seed Core Compounds: Inorganic Arsenic
 *
 * Run: npx tsx scripts/seed/09-inorganic-arsenic.ts
 */
...
const compound = { name: 'Inorganic Arsenic', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB028842', sourceName: 'Arsenate', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Inorganic Arsenic...\n');
