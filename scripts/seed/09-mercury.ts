/**
 * Seed Core Compounds: Mercury (Hg) - Total
 *
 * Run: npx tsx scripts/seed/09-mercury.ts
 */
...
const compound = { name: 'Mercury (Hg) - Total', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'HG', sourceName: 'Mercury (Hg)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'HG', sourceName: 'Mercury', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '174', sourceName: 'Mercury / Kviksølv', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003780', sourceName: 'Mercury', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Mercury (Hg) - Total...\n');
