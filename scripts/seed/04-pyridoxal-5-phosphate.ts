/**
 * Seed Core Compounds: Pyridoxal-5-Phosphate (P5P)
 *
 * Run: npx tsx scripts/seed/04-pyridoxal-5-phosphate.ts
 */
...
const compound = { name: 'Pyridoxal-5-Phosphate (P5P)', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB021820', sourceName: "Pyridoxal 5'-phosphate", sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Pyridoxal-5-Phosphate (P5P)...\n');
