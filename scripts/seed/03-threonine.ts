/**
 * Seed Core Compounds: Threonine
 *
 * Parsed from: docs/compound-mappings/03-macronutrients.md
 *
 * Run: npx tsx scripts/seed/03-threonine.ts
 */
...
// =============================================================================
// Threonine - 1 compound, 6 mappings
// =============================================================================
...
const mappings = [
  // FDC
  { source: 'FDC', externalId: '1211', sourceName: 'Threonine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  // CNF
  { source: 'CNF', externalId: '502', sourceName: 'THREONINE', sourceUnit: 'g', conversionFactor: '1.0' },
  // AFCD
  { source: 'AFCD', externalId: 'Threonine', sourceName: 'Threonine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  // FOODfiles
  { source: 'FOODfiles', externalId: 'THR', sourceName: 'Threonine', sourceUnit: 'mg', conversionFactor: '0.001' },
  // BLS
  { source: 'BLS', externalId: 'THR', sourceName: 'Threonin', sourceUnit: 'g', conversionFactor: '1.0' },
  // FRIDA
  { source: 'FRIDA', externalId: '258', sourceName: 'Threonin', sourceUnit: 'mg', conversionFactor: '0.001' },
];
