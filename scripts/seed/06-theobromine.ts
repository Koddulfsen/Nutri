/**
 * Seed Core Compounds: Theobromine
 *
 * Run: npx tsx scripts/seed/06-theobromine.ts
 */
...
const compound = { name: 'Theobromine', unit: 'mg', type: 'ALKALOID' };

const mappings = [
  { source: 'FDC', externalId: '1058', sourceName: 'Theobromine', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '263', sourceName: 'Theobromine', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB000455', sourceName: 'Theobromine', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Theobromine...\n');
