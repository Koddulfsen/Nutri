/**
 * Seed Core Compounds: Cysteine
 * Note: FDC tracks Cystine (oxidized dimer), some sources track Cysteine (reduced monomer)
 *
 * Run: npx tsx scripts/seed/03-cysteine.ts
 */
...
const compound = { name: 'Cysteine', unit: 'g', type: 'AMINO_ACID' };

const mappings = [
  { source: 'FDC', externalId: '1216', sourceName: 'Cystine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '507', sourceName: 'CYSTINE', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Cystine plus cysteine', sourceName: 'Cystine plus cysteine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'CYS', sourceName: 'Cystine', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'BLS', externalId: 'CYSTE', sourceName: 'Cystein', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '124', sourceName: 'Cystin', sourceUnit: 'mg', conversionFactor: '0.001' },
  { source: 'FooDB', externalId: '12566', sourceName: 'L-Cystine', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Cysteine...\n');
