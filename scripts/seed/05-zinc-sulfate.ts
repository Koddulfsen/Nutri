/**
 * Seed Core Compounds: Zinc Sulfate
 *
 * Run: npx tsx scripts/seed/05-zinc-sulfate.ts
 */
...
const compound = { name: 'Zinc Sulfate', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB013488', sourceName: 'Zinc sulfate', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Zinc Sulfate...\n');
