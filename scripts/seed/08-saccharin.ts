/**
 * Seed Core Compounds: Saccharin
 *
 * Run: npx tsx scripts/seed/08-saccharin.ts
 */
...
const compound = { name: 'Saccharin', unit: 'mg', type: 'SYNTHETIC_ADDITIVE' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB000918', sourceName: 'Saccharin', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Saccharin...\n');
