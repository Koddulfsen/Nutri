/**
 * Seed Core Compounds: Beta-Tocotrienol
 *
 * Run: npx tsx scripts/seed/04-beta-tocotrienol.ts
 */
...
const compound = { name: 'Beta-Tocotrienol', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '345', sourceName: 'Tocotrienol, beta', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '345', sourceName: 'Tocotrienol, beta', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'TOCTRB', sourceName: 'Beta tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'TOCTRB', sourceName: 'β-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB093543', sourceName: 'β-tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Beta-Tocotrienol...\n');
