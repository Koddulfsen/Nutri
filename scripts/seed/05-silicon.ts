/**
 * Seed Core Compounds: Silicon
 *
 * Run: npx tsx scripts/seed/05-silicon.ts
 */
...
const compound = { name: 'Silicon', unit: 'mg', type: 'MINERAL' };

const mappings = [
  { source: 'FOODfiles', externalId: 'SISOL', sourceName: 'Silicon (acid soluble)', sourceUnit: 'µg', conversionFactor: '0.001', isCanonical: true },
  { source: 'FRIDA', externalId: '234', sourceName: 'Silicium', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003713', sourceName: 'Silicon', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Silicon...\n');
