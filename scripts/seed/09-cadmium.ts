/**
 * Seed Core Compounds: Cadmium (Cd)
 *
 * Run: npx tsx scripts/seed/09-cadmium.ts
 */
...
const compound = { name: 'Cadmium (Cd)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'CD', sourceName: 'Cadmium (Cd)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'CD', sourceName: 'Cadmium', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '107', sourceName: 'Cadmium', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003766', sourceName: 'Cadmium', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Cadmium (Cd)...\n');
