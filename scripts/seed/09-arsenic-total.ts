/**
 * Seed Core Compounds: Arsenic (As) - Total
 *
 * Run: npx tsx scripts/seed/09-arsenic-total.ts
 */
...
const compound = { name: 'Arsenic (As) - Total', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'AS', sourceName: 'Arsenic (As)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'AS', sourceName: 'Arsenic', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '32', sourceName: 'Arsenic / Arsen', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB003763', sourceName: 'Arsenic', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Arsenic (As) - Total...\n');
