/**
 * Seed Core Compounds: Mead Acid (C20:3 n-9)
 *
 * Run: npx tsx scripts/seed/03-mead-acid.ts
 */
...
const compound = { name: 'Mead Acid', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'NEVO', externalId: 'F20:3CN9', sourceName: 'C20:3 n-9 cis', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: 'FDB027529', sourceName: '5,8,11-Eicosatrienoic acid', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Mead Acid...\n');
