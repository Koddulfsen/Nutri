/**
 * Seed Core Compounds: Pyridoxine
 *
 * Run: npx tsx scripts/seed/04-pyridoxine.ts
 */
...
const compound = { name: 'Pyridoxine', unit: 'mg', type: 'VITAMIN' };

// Note: Pyridoxine shares all external IDs with Vitamin B6 parent
// Most will conflict - only unique IDs will be inserted
const mappings = [
...
async function seed() {
  console.log('Seeding Pyridoxine...\n');
