/**
 * Seed Core Compounds: Added Sugars
 *
 * Run: npx tsx scripts/seed/03-added-sugars.ts
 */
...
const compound = { name: 'Added Sugars', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FDC', externalId: '1235', sourceName: 'Sugars, Added', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '539', sourceName: 'SUGAR, ADDED', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Added sugars', sourceName: 'Added sugars', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'SUGAD', sourceName: 'Sugar, added', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'Matvaretabellen', externalId: 'Sukker', sourceName: 'Sugar, added', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '417', sourceName: 'Tilsat Sukker', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Added Sugars...\n');
