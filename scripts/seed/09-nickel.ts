/**
 * Seed Core Compounds: Nickel (Ni)
 *
 * Run: npx tsx scripts/seed/09-nickel.ts
 */
...
const compound = { name: 'Nickel (Ni)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'NI', sourceName: 'Nickel (Ni)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FOODfiles', externalId: 'NI', sourceName: 'Nickel', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '204', sourceName: 'Nickel / Nikkel', sourceUnit: 'μg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB013444', sourceName: 'Nickel', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Nickel (Ni)...\n');
