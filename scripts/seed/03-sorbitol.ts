/**
 * Seed Core Compounds: Sorbitol
 *
 * Run: npx tsx scripts/seed/03-sorbitol.ts
 */
...
const compound = { name: 'Sorbitol', unit: 'g', type: 'MACRONUTRIENT' };

const mappings = [
  { source: 'FDC', externalId: '261', sourceName: 'Sorbitol', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '261', sourceName: 'Sorbitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'SORTL', sourceName: 'Sorbitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'SORTL_G', sourceName: 'Sorbitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'BLS', externalId: 'SORTL', sourceName: 'Sorbitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '237', sourceName: 'Sorbitol', sourceUnit: 'g', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: '11679', sourceName: 'D-Glucitol', sourceUnit: 'g', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Sorbitol...\n');
