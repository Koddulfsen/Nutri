/**
 * Seed Core Compounds: Dehydroascorbic Acid
 *
 * Run: npx tsx scripts/seed/04-dehydroascorbic-acid.ts
 */
...
const compound = { name: 'Dehydroascorbic Acid', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FRIDA', externalId: '177', sourceName: 'Dehydroascorbic acid', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: 'FDB011907', sourceName: 'Dehydroascorbic acid', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Dehydroascorbic Acid...\n');
