/**
 * Seed Core Compounds: Caffeine
 *
 * Run: npx tsx scripts/seed/06-caffeine.ts
 */
...
const compound = { name: 'Caffeine', unit: 'mg', type: 'ALKALOID' };

const mappings = [
  { source: 'FDC', externalId: '1057', sourceName: 'Caffeine', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '262', sourceName: 'Caffeine', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'Caffeine', sourceName: 'Caffeine', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'CAFFN', sourceName: 'Caffeine', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB002100', sourceName: 'Caffeine', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Caffeine...\n');
