/**
 * Seed Core Compounds: Gamma-Tocotrienol
 *
 * Run: npx tsx scripts/seed/04-gamma-tocotrienol.ts
 */
...
const compound = { name: 'Gamma-Tocotrienol', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '346', sourceName: 'Tocotrienol, gamma', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '346', sourceName: 'Tocotrienol, gamma', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'AFCD', externalId: 'TOCTRG', sourceName: 'Gamma tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'KFCT', externalId: 'TOCTRD', sourceName: 'γ-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB001298', sourceName: 'gamma-Tocotrienol', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Gamma-Tocotrienol...\n');
