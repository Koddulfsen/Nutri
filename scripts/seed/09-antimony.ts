/**
 * Seed Core Compounds: Antimony (Sb)
 *
 * Run: npx tsx scripts/seed/09-antimony.ts
 */
...
const compound = { name: 'Antimony (Sb)', unit: 'μg', type: 'MINERAL' };

const mappings = [
  { source: 'AFCD', externalId: 'SB', sourceName: 'Antimony (Sb)', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
  { source: 'FooDB', externalId: 'FDB003762', sourceName: 'Antimony', sourceUnit: 'μg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Antimony (Sb)...\n');
