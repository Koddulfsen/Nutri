/**
 * Seed Core Compounds: Stevia (Steviol Glycosides)
 *
 * Run: npx tsx scripts/seed/08-stevia.ts
 */
...
const compound = { name: 'Stevia (Steviol Glycosides)', unit: 'mg', type: 'SYNTHETIC_ADDITIVE' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB013538', sourceName: 'Stevioside', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Stevia (Steviol Glycosides)...\n');
