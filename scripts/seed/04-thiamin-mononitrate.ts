/**
 * Seed Core Compounds: Thiamin Mononitrate
 *
 * Run: npx tsx scripts/seed/04-thiamin-mononitrate.ts
 */
...
const compound = { name: 'Thiamin Mononitrate', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB008426', sourceName: 'Thiamine mononitrate', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Thiamin Mononitrate...\n');
