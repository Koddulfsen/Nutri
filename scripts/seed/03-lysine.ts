/**
 * Seed Core Compounds: Lysine
 *
 * Parsed from: docs/compound-mappings/03-macronutrients.md
 *
 * Run: npx tsx scripts/seed/03-lysine.ts
 */
...
// =============================================================================
// Lysine - 1 compound, 6 mappings (verified against local data 2025-02-04)
...
const mappings = [
  // FDC (1)
  { source: 'FDC', externalId: '1214', sourceName: 'Lysine', sourceUnit: 'g', conversionFactor: '1.0', isCanonical: true },
  // CNF (1)
  { source: 'CNF', externalId: '505', sourceName: 'LYSINE', sourceUnit: 'g', conversionFactor: '1.0' },
  // AFCD (1) - unit is mg/g N (per gram nitrogen), complex conversion
  { source: 'AFCD', externalId: 'Lysine', sourceName: 'Lysine', sourceUnit: 'mg/g N', conversionFactor: '1.0' },
  // FOODfiles (1)
  { source: 'FOODfiles', externalId: 'LYS', sourceName: 'Lysine', sourceUnit: 'mg', conversionFactor: '0.001' },
  // BLS (1)
  { source: 'BLS', externalId: 'LYS', sourceName: 'Lysin', sourceUnit: 'g', conversionFactor: '1.0' },
  // FRIDA (1)
  { source: 'FRIDA', externalId: '183', sourceName: 'Lysin', sourceUnit: 'mg', conversionFactor: '0.001' },
];
