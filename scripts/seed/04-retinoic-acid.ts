/**
 * Seed Core Compounds: Retinoic Acid
 *
 * Run: npx tsx scripts/seed/04-retinoic-acid.ts
 */
...
const compound = { name: 'Retinoic Acid', unit: 'μg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB022710', sourceName: 'Retinoic acid', sourceUnit: 'μg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Retinoic Acid...\n');
