/**
 * Seed Core Compounds: Phosphatidylcholine
 *
 * Run: npx tsx scripts/seed/04-phosphatidylcholine.ts
 */
...
const compound = { name: 'Phosphatidylcholine', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '1182', sourceName: 'Choline, from phosphatidylcholine', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '422', sourceName: 'Choline, from phosphatidylcholine', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Phosphatidylcholine...\n');
