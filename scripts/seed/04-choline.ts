/**
 * Seed Core Compounds: Choline (Total)
 *
 * Run: npx tsx scripts/seed/04-choline.ts
 */
...
const compound = { name: 'Choline (Total)', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FDC', externalId: '1180', sourceName: 'Choline, total', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
  { source: 'CNF', externalId: '430', sourceName: 'Choline, total', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FOODfiles', externalId: 'CHOLN', sourceName: 'Choline', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FRIDA', externalId: '116', sourceName: 'Choline', sourceUnit: 'mg', conversionFactor: '1.0' },
  { source: 'FooDB', externalId: 'FDB000710', sourceName: 'Choline', sourceUnit: 'mg', conversionFactor: '1.0' },
];

async function seed() {
  console.log('Seeding Choline (Total)...\n');
