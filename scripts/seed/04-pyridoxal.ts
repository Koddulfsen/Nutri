/**
 * Seed Core Compounds: Pyridoxal
 *
 * Run: npx tsx scripts/seed/04-pyridoxal.ts
 */
...
const compound = { name: 'Pyridoxal', unit: 'mg', type: 'VITAMIN' };

const mappings = [
  { source: 'FooDB', externalId: 'FDB011169', sourceName: 'Pyridoxal', sourceUnit: 'mg', conversionFactor: '1.0', isCanonical: true },
];

async function seed() {
  console.log('Seeding Pyridoxal...\n');
